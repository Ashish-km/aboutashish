    ...
    <>
      <>
        ...
        <Head>
          ...
          <title>{profile.title} Ashish Kushwah</title>
                ...
                <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                  ...
                  <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                    ...
                    <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                      <a href="https://www.facebook.com/profile.php?id=100049630595643&mibextid=ZbWKwL">
                        <i className="bx bxl-facebook-square text-2xl text-white hover:text-yellow"></i>
                      </a>
                      {/* <a href={profile.twitterLink} className="pl-4">
                    <i className="bx bxl-twitter text-2xl text-white hover:text-yellow"></i>
                  </a> */}
                      <a href="https://github.com/Ashish-km" className="pl-4">
                        <i className="bx bxl-github text-2xl text-white hover:text-yellow"></i>
                      </a>
                      <a
                        href="https://www.linkedin.com/in/ashish-kushwah-1b818b21a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                        className="pl-4"
                      >
                      ...
                      <a
                        href="https://instagram.com/ashish___kushwah?igshid=NGVhN2U2NjQ0Yg=="
                        className="pl-4"
                      >
            ...
            <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
              <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                  I'm Ashish Kushwah, a Frontend Developer
                </h4>
                <p className="pt-6 font-body leading-relaxed text-grey-20">

                  I'm a dedicated Web Developer with a Bachelor's in Technology from Indore Institute of Science & Technology (2023). My practical experience at Walkover and OS SOFT INDIA honed my skills in front-end development and digital solutions. Notable projects include a Hospital Management System and a Role-Based System in Angular. Certified in HTML, CSS, SQL, and JAVA, I'm proficient in C, HTML, SCSS, CSS, JavaScript, SQL, Java, and Bootstrap 5. Beyond tech, I enjoy gaming, traveling, and music. Eager to contribute my skills and continue learning in a dynamic organization.
                </p>
...
<<<<<<< HEAD
            <form className="mx-auto w-full pt-10 sm:w-3/4" action="https://api.web3forms.com/submit" method="POST">
...
=======
            ...
            <ContactForm />
>>>>>>> f8bfc9f7b011fcf00dec1eb54b5d9b2c31f85868
